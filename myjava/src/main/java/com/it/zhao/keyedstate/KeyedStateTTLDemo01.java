...
public class KeyedStateTTLDemo01 {
    public static void main(String[] args) throws Exception {
        ...
        ds3.map(new RichMapFunction<Tuple2<String, Integer>, Tuple2<String, Integer>>() {
            ...
            public void open(Configuration parameters) throws Exception {
                //设置ttl配置
                StateTtlConfig ttlConfig = StateTtlConfig.newBuilder(Time.seconds(10))//存活10秒
                        .setUpdateType(StateTtlConfig.UpdateType.OnCreateAndWrite)//创建或写入时更新时间
                        .setStateVisibility(StateTtlConfig.StateVisibility.NeverReturnExpired)//不要过期数据
                        .build();
                //创建状态描述器
