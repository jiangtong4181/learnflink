...
public class RestartStrategyDemo01 {
    public static void main(String[] args) throws Exception {
        StreamExecutionEnvironment env = StreamExecutionEnvironment.createLocalEnvironmentWithWebUI(new Configuration());
        //设定重启策略
        //fixedDelayRestart 固定次数与延迟时间
        //env.setRestartStrategy(RestartStrategies.fixedDelayRestart(3,Time.milliseconds(3000)));
        //在规定时间内重启达到最大次数，job会退出
